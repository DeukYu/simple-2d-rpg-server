...
IF ERRORLEVEL 1 PAUSE
XCOPY /Y Protocol.cs "../../../../simple-2d-rpg-client/Assets/Scripts/Packet"
XCOPY /Y Protocol.cs "../../CS_Server/Packet"
XCOPY /Y Protocol.cs "../../DummyClient/Packet"

XCOPY /Y Common.cs "../../../../simple-2d-rpg-client/Assets/Scripts/Packet"
REM XCOPY /Y Common.cs "../../CS_Server/Packet"
REM XCOPY /Y Common.cs "../../WebServer/Packet"
XCOPY /Y Common.cs "../../Shared"

XCOPY /Y Enum.cs "../../../../simple-2d-rpg-client/Assets/Scripts/Packet"
XCOPY /Y Enum.cs "../../Shared"

XCOPY /Y WebProtocol.cs "../../../../simple-2d-rpg-client/Assets/Scripts/Packet"
XCOPY /Y WebProtocol.cs "../../WebServer/Packet"
XCOPY /Y WebProtocol.cs "../../DummyClient/Packet"
REM XCOPY /Y ClientPacketManager.cs "../../../../GuardianOfNature2D/Assets/Scripts/Packet"
